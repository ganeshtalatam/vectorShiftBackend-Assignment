...
authorization_url = f'https://airtable.com/oauth2/v1/authorize?client_id={AIRTABLE_CLIENT_ID}&response_type=code&owner=user&redirect_uri=http%3A%2F%2Flocalhost%3A8000%2Fintegrations%2Fairtable%2Foauth2callback'
